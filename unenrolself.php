...
$instance = $DB->get_record('enrol', array('id' => $enrolid, 'enrol' => 'weepaypayment'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/weepaypayment/unenrolself.php', array('enrolid' => $instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_weepaypayment', format_string($course->fullname));
